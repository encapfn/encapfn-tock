...
pub unsafe fn main() {
    ...
    #[cfg(any(feature = "og_eval_ubench_invoke", feature = "og_eval_ubench_validate", feature = "og_eval_ubench_upgrade", feature = "og_eval_ubench_callback"))]
    ...
    #[cfg(feature = "og_eval_ubench_setup")]
    {
        ...
        encapfn_tock::print_ogbench_result("setup_unsafe", None::<()>, (SETUP_ITERS, start_unsafe, end_unsafe), hardware_alarm);
        encapfn_tock::print_ogbench_result("setup_ef", None::<()>, (SETUP_ITERS, start_ef, end_ef), hardware_alarm);
    }
    // -------------------------------------------------------------------------
