...
pub struct OTCryptoLibHMAC<'l, ID: EFID, RT: EncapfnRt<ID = ID>, L: LibOTCryptoMAC<ID, RT, RT = RT>>
{
    lib: &'l L,
...
impl<'l, ID: EFID, RT: EncapfnRt<ID = ID>, L: LibOTCryptoMAC<ID, RT, RT = RT>>
    OTCryptoLibHMAC<'l, ID, RT, L>
{
        ...
        ) -> R,
    {
        ...
        let res = self
            .lib
            .rt()
            .allocate_stacked_t_mut::<otcrypto_mac_ef_bindings::hmac_context_t, _, _>(
                alloc,
...
impl<'l, ID: EFID, RT: EncapfnRt<ID = ID>, L: LibOTCryptoMAC<ID, RT, RT = RT>> DeferredCallClient
...
impl<'l, ID: EFID, RT: EncapfnRt<ID = ID>, L: LibOTCryptoMAC<ID, RT, RT = RT>> digest::HmacSha256
    for OTCryptoLibHMAC<'l, ID, RT, L>
{
...
impl<'l, ID: EFID, RT: EncapfnRt<ID = ID>, L: LibOTCryptoMAC<ID, RT, RT = RT>> digest::HmacSha384
    for OTCryptoLibHMAC<'l, ID, RT, L>
{
...
impl<'l, ID: EFID, RT: EncapfnRt<ID = ID>, L: LibOTCryptoMAC<ID, RT, RT = RT>> digest::HmacSha512
    for OTCryptoLibHMAC<'l, ID, RT, L>
{
